...
module.exports = {
    "subaccount": [
        ...
        },
        {
            ...
            "params": [
                ...
                {
                    "parameter": "eceive payments for the created subaccount by providing their code when doing a transaction. More details here: [Split Payments Overview](https://developers.paystack.co/v1.0/docs/splitpaymentsoverview",
                    "required": false,
                    "type": "String"
                }
            ],
    ...
    "page": [
        ...
        },
        {
            ...
            "params": [
                ...
                {
                    "parameter": "end pages created to your customers by giving out a link in this format https://paystack.com/pay/:slug. For instance, a valid link for the page above would be https://paystack.com/pay/5nApBwZkv",
                    "required": false,
                    "type": "String"
                }
            ],
    ...
    "transfer": [
        ...
        },
        {
            ...
            "params": [
                ...
                {
                    "parameter": "n the event that you want to be able to complete transfers programmatically without use of OTPs, this endpoint helps disable that….with an OTP. No arguments required. An OTP is sent to you on your business phone",
                    "required": true,
                    "type": "String"
                }
            ],
        ...
        },
        {
            ...
            "params": [
                ...
                {
                    "parameter": "tatus of transfer object returned will be ‘pending’ if OTP is disabled. In the event that an OTP is required, status will read ‘otp’",
                    "required": true,
                    "type": "String"
                }
            ],
        ...
        },
        {
            ...
            "description": "Creates a new recipient. An duplicate account number will lead to the retrieval of the existing record.\n\n**Body Params**\n- **transfer_code** (_required_) - Transfer code\n- **reason** (_required_) - either `resend_otp` or `transfer`"
        }
    ],
    "paymentrequest": [
        {
        ...
        },
        {
            ...
            "description": "Publishes invoice that is draft by sending customer the invoice via email\n\n**Body Params**\n- **send_notification** - Indicates whether Paystack sends an email notification to customer. Defaults to `true`"
        },
        {
            "api": "send",
        ...
        {
            "api": "verify",
            "endpoint": "https://api.paystack.co/paymentrequest/verify/ID_OR_CODE",
            "method": "GET",
            "params": [
                {
                    "parameter": "ID",
                ...
                {
                    "parameter": "ote that a key is added called `pending_amount` when you fetch an invoice. This is because when paying for an invoice, you can choose to pay part but not all.  Whenever a successful transaction is made, the key updates to reveal what’s left of the invoice to pay",
                    "required": false,
                    "type": "String"
                }
            ],
    ...
    "subscription": [
        ...
        },
        {
            ...
            "params": [
                ...
                {
                    "parameter": "ote the `email_token` attribute for the subscription object. We create one on each subscription so customers can cancel their subscriptions from within the invoices sent to their mailboxes. Since they are not authorized, the email tokens are what we use to authenticate the requests over the API",
                    "required": false,
                    "type": "String"
                }
            ],
    ...
    "bulkcharge": [
        ...
        },
        {
            ...
            "description": "Send an array of objects with authorization codes and amount in kobo so we can process transactions as a batch.\n\n**Body Params**\n- **(no_name)**"
        },
        {
            "api": "resume",
    ...
    "bank": [
        ...
        },
        {
            ...
            "params": [
                ...
                {
                    "parameter": "*bank_code* _(required)_  Bank code from [List Bank endpoint](https://api.paystack.co/bank",
                    "required": true,
                    "type": "String"
                },
                {
    ...
    "charge": [
        ...
        },
        {
            ...
            "description": "When you get \"pending\" as a charge status, wait 30 seconds or more, then make a check to see if its status has changed. Don't call too early as you may get a lot more pending than you should.\n\n**Body Params**\n- **reference** (_required_) - The reference to check"
        },
        {
            "api": "charge",
            ...
            "params": [
                {
                    "parameter": "imple guide to charging cards directly https://developers.paystack.co/docs/chargingfromyourbacken",
                    "required": false,
                    "type": "String"
                },
    ...
    "balance": [
        ...
        },
        {
            ...
            "method": "GET",
            "params": [],
            "description": "Returns all activity carried out from and to the Paystack Balance"
        }
    ],
    "settlement": [
        {
