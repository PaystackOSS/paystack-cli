...
module.exports = {
  ...
  transfer: [
    ...
    {
      api: 'fetch',
      endpoint: 'https://api.paystack.co/transfer/code',
      method: 'GET',
      params: [
        {
          parameter: 'code',
  ...
  bulkcharge: [
    {
      api: 'fetch',
      endpoint: 'https://api.paystack.co/bulkcharge/{code}',
      method: 'GET',
      params: [
    ...
    {
      api: 'fetch',
      endpoint: 'https://api.paystack.co/bulkcharge/{code}/charges',
      method: 'GET',
      params: [
    ...
    {
      api: 'pause',
      endpoint: 'https://api.paystack.co/bulkcharge/pause/{code}',
      method: 'GET',
      params: [
  ...
  bank: [
    ...
    },
    {
      ...
      description: 'This endpoint can be used to confirm that an account number and bank code match. It returns the following details: Account name, Account number and Bank ID',
    },
  ],
  identity: [
    {
      api: 'resolve_bvn',
      endpoint: 'https://api.paystack.co/bank/resolve_bvn/{bvn}',
      method: 'GET',
      params: [
        {
          parameter: 'bvn',
      ...
      description: 'The Resolve BVN service helps you build a KYC profile for a Nigeria-based customer using their BVN.',
    },
    {
      api: 'resolve_bvn_premium',
      endpoint: 'https://api.paystack.co/identity/bvn/resolve/{bvn}',
      method: 'GET',
      params: [
        {
          parameter: 'bvn',
    ...
    {
      api: 'match_bvn',
      endpoint: 'https://api.paystack.co/bvn/match',
      method: 'POST',
      params: [
    ...
    {
      api: 'resolve_card_bin',
      endpoint: 'https://api.paystack.co/decision/bin/{bin)',
      method: 'GET',
      params: [
        {
          parameter: 'bin',
  ...
  customer: [
    {
      api: 'update',
      endpoint: 'https://api.paystack.co/customer/{id}',
      method: 'PUT',
      params: [
        {
          parameter: 'first_name',
  ...
  integration: [
    {
      ...
      description: ' Time before stopping session (in seconds). Set to 0 to cancel session timeouts',
    },
    {
      api: 'fetch',
      endpoint: 'https://api.paystack.co/integration/payment_session_timeout',
